...
public class Anagrams {
    ...
    public char swapElements(char firstChar, char secondChar) {
	       return secondChar;
	   }
	...
	String inputWords[] = inputString.split(split);
	...
	return String.join(split, outputWords);
    }
	...
	for (int i = 0; i < outputWord.length; i++) {
		...
		if (!Character.isLetter(outputWord[beginIndex])) {
			...
			outputWord[endIndex] = swapElements(outputWord[endIndex],
				outputWord[beginIndex]);
